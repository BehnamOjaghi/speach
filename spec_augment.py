...
class SpecAugment(tf.keras.layers.Layer):
  ...
  probability: probability of applying SpecAugment. By default, half of the instances are augmented.
  """
  def __init__(self,f_gaps = [0,2],t_gaps = [0,2],f_gap_size=[5,10],t_gap_size=[5,10],probability=0.5,name=None):
